...
export function QuickActionsBar() {
  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-xl p-2 flex flex-wrap gap-2">
      <button suppressHydrationWarning className="flex-1 min-w-[120px] bg-white/5 hover:bg-white/10 border border-transparent hover:border-white/10 text-white text-sm font-medium py-2 px-3 rounded-lg flex items-center justify-center gap-2 transition-colors">
